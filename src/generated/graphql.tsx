...
export type PostQuery = { __typename?: 'Query', post?: Maybe<{ __typename?: 'Post', id: number, createdAt: string, updatedAt: string, title: string, points: string, text: string, voteStatus?: Maybe<number> }> };
